...
AFRAME.registerComponent('custom-gltf-model', {
  schema: { type: 'model' },
  ...
  update: function () {
    ...
    this.loader.load(
      ...
      function gltfLoaded(gltfModel) {
        ...
        console.log('[D] self.model: ', self.model);

        el.setObject3D('mesh', self.model);

        const mountainMesh = self.model.getObjectByName('mountain');
        mountainMesh.material = new THREE.MeshPhysicalMaterial({
          color: '#000000',
          roughness: 0,
        });

        mountainMesh.material.onBeforeCompile = function (shader) {
